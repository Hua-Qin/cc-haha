...
export const jp: Record<TranslationKey, string> = {
  ...
  'commands.pin': 'ピン留め',
  'commands.unpin': 'ピン解除',
  'commands.group.title': 'カスタムグループ',
  'commands.group.description': 'カスタムグループを作成して、コマンドを独自の方法で整理します。',
  'commands.group.create': 'グループ作成',
  'commands.group.edit': '編集',
  'commands.group.delete': '削除',
  'commands.group.name': 'グループ名',
  'commands.group.namePlaceholder': 'グループ名を入力...',
  'commands.group.empty': 'カスタムグループがありません。整理を始めるには作成してください。',
  'commands.group.count': '{count} コマンド',
  'commands.group.uncategorized': '未分類',
  'commands.group.moveTo': 'グループに移動',
  'commands.group.moveToNone': 'グループなし',
  'commands.group.dragHint': 'ドラッグしてグループに移動',
  'commands.group.createTitle': 'コマンドグループを作成',
  'commands.group.editTitle': 'コマンドグループを編集',
  'commands.group.deleteConfirm': 'このグループを削除しますか？含まれるコマンドは未分類に戻ります。',
  'commands.group.nameRequired': 'グループ名は必須です',
  'commands.group.nameExists': '同じ名前のグループがすでに存在します',
  'commands.group.save': '保存',
  'commands.group.addCommands': '下のコマンドリストからこのグループにコマンドを追加してください。',
  'commands.group.expand': 'グループを展開',
  'commands.group.collapse': 'グループを折りたたむ',

  // ─── Chat Input ──────────────────────────────────────
  'chat.placeholder': '編集、デバッグ、説明を Claude に依頼...',
  'chat.optimize.success': 'プロンプトの最適化に成功しました',
  'chat.optimize.error': 'プロンプトの最適化に失敗しました',
  'chat.optimize.authError': 'プロンプト最適化を使用するには、ログインまたはプロバイダー設定で API Key を設定してください',
  'chat.optimize.optimizing': '最適化中...',
  'chat.optimize.button': 'プロンプト最適化',
  'chat.optimize.disabled': '設定でプロンプト最適化を有効にしてください',
  'settings.promptOptimization.title': 'AI プロンプト最適化',
  'settings.promptOptimization.description': 'チャット入力に「プロンプト最適化」ボタンを追加し、AI でメッセージをより明確なプロンプトに書き直します。',
  'settings.promptOptimization.enable': 'プロンプト最適化を有効化',
  'settings.promptOptimization.enableHint': '有効にすると、チャットツールバーに魔法の杖ボタンが表示されます。',
  'settings.promptOptimization.instruction': '最適化指示',
  'settings.promptOptimization.instructionHint': 'このシステムプロンプトはモデルにメッセージの書き方を指示します。編集して動作をカスタマイズできます。',
  'settings.promptOptimization.instructionPlaceholder': 'モデルの最適化指示を入力...',
  'settings.promptOptimization.model': 'モデル',
  'settings.promptOptimization.modelHint': '空欄の場合は現在選択中のモデルを使用、またはモデルを指定（例: haiku、sonnet）。',
  'settings.promptOptimization.modelPlaceholder': '空欄 = 現在のモデルを使用',
  'settings.promptOptimization.temperature': '温度',
  'settings.promptOptimization.temperatureHint': '低いほど集中、高いほど創造的。',
  'settings.promptOptimization.resetInstruction': 'デフォルトに戻す',
  'settings.promptOptimization.saved': 'プロンプト最適化設定を保存しました',
