...
export const kr: Record<TranslationKey, string> = {
  ...
  'commands.group.title': '사용자 정의 그룹',
  'commands.group.description': '사용자 정의 그룹을 만들어 나만의 방식으로 명령을 정리하세요.',
  'commands.group.create': '그룹 만들기',
  'commands.group.edit': '편집',
  'commands.group.delete': '삭제',
  'commands.group.name': '그룹 이름',
  'commands.group.namePlaceholder': '그룹 이름 입력...',
  'commands.group.empty': '사용자 정의 그룹이 없습니다. 명령 정리를 시작하려면 만드세요.',
  'commands.group.count': '{count}개 명령',
  'commands.group.uncategorized': '미분류',
  'commands.group.moveTo': '그룹으로 이동',
  'commands.group.moveToNone': '그룹 없음',
  'commands.group.dragHint': '드래그하여 그룹으로 이동',
  'commands.group.createTitle': '명령 그룹 만들기',
  'commands.group.editTitle': '명령 그룹 편집',
  'commands.group.deleteConfirm': '이 그룹을 삭제하시겠습니까? 포함된 명령은 미분류로 돌아갑니다.',
  'commands.group.nameRequired': '그룹 이름은 필수입니다',
  'commands.group.nameExists': '같은 이름의 그룹이 이미 존재합니다',
  'commands.group.save': '저장',
  'commands.group.addCommands': '아래 명령 목록에서 이 그룹에 명령을 추가하세요.',
  'commands.group.expand': '그룹 펼치기',
  'commands.group.collapse': '그룹 접기',

  // ─── Chat Input ──────────────────────────────────────
  'chat.placeholder': '편집, 디버그 또는 설명을 Claude에 요청...',
  'chat.optimize.success': '프롬프트 최적화 성공',
  'chat.optimize.error': '프롬프트 최적화 실패',
  'chat.optimize.authError': '프롬프트 최적화를 사용하려면 로그인하거나 제공자 설정에서 API Key를 구성하세요',
  'chat.optimize.optimizing': '최적화 중...',
  'chat.optimize.button': '프롬프트 최적화',
  'chat.optimize.disabled': '설정에서 프롬프트 최적화를 활성화하세요',
  'settings.promptOptimization.title': 'AI 프롬프트 최적화',
  'settings.promptOptimization.description': '채팅 입력에 「프롬프트 최적화」 버튼을 추가하여 AI로 메시지를 더 명확한 프롬프트로 다시 작성합니다.',
  'settings.promptOptimization.enable': '프롬프트 최적화 활성화',
  'settings.promptOptimization.enableHint': '활성화하면 채팅 도구 모음에 마법 지팡이 버튼이 표시됩니다.',
  'settings.promptOptimization.instruction': '최적화 지시',
  'settings.promptOptimization.instructionHint': '이 시스템 프롬프트는 모델에 메시지 재작성 방법을 지시합니다. 편집하여 동작을 사용자 정의할 수 있습니다.',
  'settings.promptOptimization.instructionPlaceholder': '모델의 최적화 지시 입력...',
  'settings.promptOptimization.model': '모델',
  'settings.promptOptimization.modelHint': '비워두면 현재 선택된 모델 사용, 또는 모델 지정 (예: haiku, sonnet).',
  'settings.promptOptimization.modelPlaceholder': '비워두면 현재 모델 사용',
  'settings.promptOptimization.temperature': '온도',
  'settings.promptOptimization.temperatureHint': '낮을수록 집중, 높을수록 창의적.',
  'settings.promptOptimization.resetInstruction': '기본값으로 재설정',
  'settings.promptOptimization.saved': '프롬프트 최적화 설정이 저장되었습니다',
