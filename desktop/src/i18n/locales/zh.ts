...
export const zh: Record<TranslationKey, string> = {
  ...
  'commands.pin': '置顶',
  'commands.unpin': '取消置顶',
  'commands.group.title': '自定义分组',
  'commands.group.description': '创建自定义分组，按你的方式组织命令。',
  'commands.group.create': '创建分组',
  'commands.group.edit': '编辑',
  'commands.group.delete': '删除',
  'commands.group.name': '分组名称',
  'commands.group.namePlaceholder': '输入分组名称...',
  'commands.group.empty': '尚无自定义分组。创建一个开始组织命令。',
  'commands.group.count': '{count} 个命令',
  'commands.group.uncategorized': '未分类',
  'commands.group.moveTo': '移动到分组',
  'commands.group.moveToNone': '无分组',
  'commands.group.dragHint': '拖拽到分组',
  'commands.group.createTitle': '创建命令分组',
  'commands.group.editTitle': '编辑命令分组',
  'commands.group.deleteConfirm': '删除此分组？其中的命令将回到未分类。',
  'commands.group.nameRequired': '分组名称不能为空',
  'commands.group.nameExists': '已存在同名分组',
  'commands.group.save': '保存',
  'commands.group.addCommands': '从下方命令列表中将命令添加到此分组。',
  'commands.group.expand': '展开分组',
  'commands.group.collapse': '收起分组',

  // ─── Chat Input ──────────────────────────────────────
  'chat.placeholder': '让 Claude 编辑、调试或解释代码...',
  'chat.optimize.success': '提示词优化成功',
  'chat.optimize.error': '提示词优化失败',
  'chat.optimize.authError': '请先登录或在服务商设置中配置 API Key 后再使用提示词优化',
  'chat.optimize.optimizing': '优化中...',
  'chat.optimize.button': '优化提示词',
  'chat.optimize.disabled': '请在设置中启用提示词优化',
  'settings.promptOptimization.title': 'AI 提示词优化',
  'settings.promptOptimization.description': '在聊天输入框中添加"优化提示词"按钮，使用 AI 将你的消息重写为更清晰的提示词。',
  'settings.promptOptimization.enable': '启用提示词优化',
  'settings.promptOptimization.enableHint': '启用后，聊天工具栏会显示魔法棒按钮。',
  'settings.promptOptimization.instruction': '优化指令',
  'settings.promptOptimization.instructionHint': '此系统提示词告诉模型如何重写你的消息。编辑它可自定义优化行为。',
  'settings.promptOptimization.instructionPlaceholder': '输入模型的优化指令...',
  'settings.promptOptimization.model': '模型',
  'settings.promptOptimization.modelHint': '留空则使用当前选择的模型，或指定模型（如 haiku、sonnet）。',
  'settings.promptOptimization.modelPlaceholder': '留空使用当前模型',
  'settings.promptOptimization.temperature': '温度',
  'settings.promptOptimization.temperatureHint': '越低越专注，越高越有创造力。',
  'settings.promptOptimization.resetInstruction': '恢复默认',
  'settings.promptOptimization.saved': '提示词优化设置已保存',
