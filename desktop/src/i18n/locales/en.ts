export const en = {
  ...
  'commands.group.title': 'Custom Groups',
  'commands.group.description': 'Create custom groups to organize commands your way.',
  'commands.group.create': 'Create Group',
  'commands.group.edit': 'Edit',
  'commands.group.delete': 'Delete',
  'commands.group.name': 'Group name',
  'commands.group.namePlaceholder': 'Enter group name...',
  'commands.group.empty': 'No custom groups yet. Create one to start organizing.',
  'commands.group.count': '{count} commands',
  'commands.group.uncategorized': 'Uncategorized',
  'commands.group.moveTo': 'Move to group',
  'commands.group.moveToNone': 'No group',
  'commands.group.dragHint': 'Drag to group',
  'commands.group.createTitle': 'Create Command Group',
  'commands.group.editTitle': 'Edit Command Group',
  'commands.group.deleteConfirm': 'Delete this group? Commands in it will return to uncategorized.',
  'commands.group.nameRequired': 'Group name is required',
  'commands.group.nameExists': 'A group with this name already exists',
  'commands.group.save': 'Save',
  'commands.group.addCommands': 'Add commands to this group from the command list below.',
  'commands.group.expand': 'Expand group',
  'commands.group.collapse': 'Collapse group',
  ...
  'chat.optimize.authError': 'Please log in or configure an API Key in provider settings to use prompt optimization',
  ...
  'settings.promptOptimization.title': 'AI Prompt Optimization',
  'settings.promptOptimization.description': 'Add an "Optimize Prompt" button to the chat input that rewrites your message into a clearer prompt using AI.',
  'settings.promptOptimization.enable': 'Enable prompt optimization',
  'settings.promptOptimization.enableHint': 'When enabled, a wand button appears in the chat toolbar.',
  'settings.promptOptimization.instruction': 'Optimization instruction',
  'settings.promptOptimization.instructionHint': 'This system prompt tells the model how to rewrite your message. Edit it to customize the behavior.',
  'settings.promptOptimization.instructionPlaceholder': 'Enter the optimization instruction for the model...',
  'settings.promptOptimization.model': 'Model',
  'settings.promptOptimization.modelHint': 'Leave empty to use the currently selected model, or specify a model (e.g. haiku, sonnet).',
  'settings.promptOptimization.modelPlaceholder': 'Empty = use current model',
  'settings.promptOptimization.temperature': 'Temperature',
  'settings.promptOptimization.temperatureHint': 'Lower = more focused, higher = more creative.',
  'settings.promptOptimization.resetInstruction': 'Reset to default',
  'settings.promptOptimization.saved': 'Prompt optimization settings saved',
