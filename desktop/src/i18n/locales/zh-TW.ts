...
export const zh: Record<TranslationKey, string> = {
  ...
  'commands.pin': '置頂',
  'commands.unpin': '取消置頂',
  'commands.group.title': '自訂分組',
  'commands.group.description': '建立自訂分組，按你的方式組織命令。',
  'commands.group.create': '建立分組',
  'commands.group.edit': '編輯',
  'commands.group.delete': '刪除',
  'commands.group.name': '分組名稱',
  'commands.group.namePlaceholder': '輸入分組名稱...',
  'commands.group.empty': '尚無自訂分組。建立一個開始組織命令。',
  'commands.group.count': '{count} 個命令',
  'commands.group.uncategorized': '未分類',
  'commands.group.moveTo': '移動到分組',
  'commands.group.moveToNone': '無分組',
  'commands.group.dragHint': '拖曳到分組',
  'commands.group.createTitle': '建立命令分組',
  'commands.group.editTitle': '編輯命令分組',
  'commands.group.deleteConfirm': '刪除此分組？其中的命令將回到未分類。',
  'commands.group.nameRequired': '分組名稱不能為空',
  'commands.group.nameExists': '已存在同名分組',
  'commands.group.save': '儲存',
  'commands.group.addCommands': '從下方命令清單中將命令加入到此分組。',
  'commands.group.expand': '展開分組',
  'commands.group.collapse': '收起分組',

  // ─── Chat Input ──────────────────────────────────────
  'chat.placeholder': '讓 Claude 編輯、除錯或解釋程式碼...',
  'chat.optimize.success': '提示詞優化成功',
  'chat.optimize.error': '提示詞優化失敗',
  'chat.optimize.authError': '請先登入或在服務商設定中配置 API Key 後再使用提示詞優化',
  'chat.optimize.optimizing': '優化中...',
  'chat.optimize.button': '優化提示詞',
  'chat.optimize.disabled': '請在設定中啟用提示詞優化',
  'settings.promptOptimization.title': 'AI 提示詞優化',
  'settings.promptOptimization.description': '在聊天輸入框中新增「優化提示詞」按鈕，使用 AI 將你的訊息重寫為更清晰的提示詞。',
  'settings.promptOptimization.enable': '啟用提示詞優化',
  'settings.promptOptimization.enableHint': '啟用後，聊天工具列會顯示魔法棒按鈕。',
  'settings.promptOptimization.instruction': '優化指令',
  'settings.promptOptimization.instructionHint': '此系統提示詞告訴模型如何重寫你的訊息。編輯它可自訂優化行為。',
  'settings.promptOptimization.instructionPlaceholder': '輸入模型的優化指令...',
  'settings.promptOptimization.model': '模型',
  'settings.promptOptimization.modelHint': '留空則使用當前選擇的模型，或指定模型（如 haiku、sonnet）。',
  'settings.promptOptimization.modelPlaceholder': '留空使用當前模型',
  'settings.promptOptimization.temperature': '溫度',
  'settings.promptOptimization.temperatureHint': '越低越專注，越高越有創造力。',
  'settings.promptOptimization.resetInstruction': '恢復預設',
  'settings.promptOptimization.saved': '提示詞優化設定已儲存',
